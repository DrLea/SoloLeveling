...
- `plans`: map date → the plans that have already been applied
...
- Base the message on real facts: the streak, the last 7 days, yesterday's result, and upcoming deadlines. Don't add fluff.
